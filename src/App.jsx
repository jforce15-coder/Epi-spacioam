...
/* ─── Detail Modal */
function DetailModal({rep,vendors,props,onClose,onMarkPaid,onDelete,onSave,onQA,hasLinkedDmg,onExtract}) {
        ...
        <div style={{padding:"22px 24px",display:"flex",flexDirection:"column",gap:18}}>
          ...
          {!editing&&(
            <div style={{display:"flex",flexDirection:"column",gap:18}}>
              ...
              {isCleaning(rep.categoria)&&rep.hayDanios&&rep.danios&&rep.danios.length>0&&(
                <div style={{display:"flex",flexDirection:"column",gap:10}}>
                  ...
                  {hasLinkedDmg
                    ...
                    : (onExtract&&<button onClick={function(){onExtract(rep);}} style={{padding:"11px 14px",borderRadius:10,border:"1.5px solid #DBC8C4",background:"#fff",color:C.red,fontSize:12.5,fontWeight:700,cursor:"pointer"}}>↪ Extraer daños como reporte independiente →</button>)}
                </div>
              )}
              ...
              {rep.total&&!isDanos(rep.categoria)&&(
                <div style={{borderTop:"1px solid "+C.gray,paddingTop:16}}>
